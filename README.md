...
On RedHat/CentOS, you may need to have EPEL installed before running this role. You can use the `repo-epel` role if you need a simple way to ensure it's installed.
